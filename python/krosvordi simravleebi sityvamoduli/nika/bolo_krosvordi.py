...
def milocva():
    ...
    """
    print("გილოცავ, მომხმარებელო! შენ წარმატებულად შეავსე კროსმორდი!")
    print("რამეს კარგ გუსურვებ და გიმეჭდავ ამას კონსოლში! ;წ w(0_0)W")
...
def main():
    ...
    while not mougia:
        ...
        # user_text = str(input("შეიტანე სავარაუდო პასუხი/სიტყვა: "))
        ...
        text_damushaveba = sityvtamoduli.tsinadadebis_damushaveba(user_text)
        print(f'წინადადების გახლეჩის შედეგი: {text_damushaveba}')
        ...
        # for i in text_damushaveba:
        for sityva in text_damushaveba:
            # sityvtamoduli.sityvis_damushaveba(i)
            sityvtamoduli.sityvis_damushaveba(sityva)

            # ბ. sityvtamoduli-დან გამოიძახე sityvis_analizi ფუნქცია, და დაბეჭდე
            # ანალიზის შედეგი
            # print(sityvtamoduli.sityvis_analizi(i))
            print(sityvtamoduli.sityvis_analizi(sityva))


            # გ. მომხმარებელს ჰკითხე, რა ადგილას სსურს სიტყვის ჩაწერა, ადგილი უნდა იყოს
            # მთელრიცხვა ტიპის მონაცემი
            where = int(input("მომხმარებელო, რა ადგილას გსურს სიტყვის ჩაწერა?: "))

            # დ. შეამოწმე პასუხები, pasuxis_shemotsmeba ფუნქციის გამოძახებით;
            # შედეგი შეინახე ცვლადში
            # answer = pasuxis_shemotsmeba(STSORI_PASUXEBI,where,user_text)
            # answer = pasuxis_shemotsmeba(SITYVEBI_PASUXEBI, where, user_text)
            answer = pasuxis_shemotsmeba(SITYVEBI_PASUXEBI, where, sityva)



            # ე. კონსოლში გამოიტანე მომხმარელის მიერ შეტანილი სიტყვა და ადგილი,
            # და წინა ფუნქციის გამოძახდების შედეგი - სწორი იყო თუ არა
            print(f"თქვენი სიტყვა: {user_text}, ადგილი: {where}")
            print(answer)
